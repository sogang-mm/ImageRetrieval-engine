...
from RetrievalEngine import config


os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'RetrievalEngine.settings')

app = Celery('RetrievalEngine')
...
app.conf.beat_schedule = {
    'delete-old-database': {
        'task': 'Engine.beats.delete_old_database',
        'schedule': crontab(
